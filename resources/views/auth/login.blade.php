...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        @else
            <a href="{{route('admin::dashboard.index')}}"> <i class="fa fa-check-circle"></i> Você já está logado, clique aqui para prosseguir.</a>
        @endif
        <!-- /.social-auth-links -->
    ...
    <p class="text-center">
        Desenvolvido por <a target="_blank" href="#">Luís Fernando</a>
    </p>
</div>
<!-- /.login-box -->
